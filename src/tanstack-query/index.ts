...
import { treaty, type Treaty } from '../treaty2'
import type {
    EdenTQ,
    EdenTQUtils,
    EdenQueryOptions,
...
export function createEdenTQUtils<
    T extends { readonly __app: Elysia<any, any, any, any, any, any, any> }
>(
    eden: T,
    queryClient: QueryClient
): EdenTQUtils.Create<T['__app']> {
    ...
    return createEdenTQUtilsProxy(utilsCtx) as EdenTQUtils.Create<T['__app']>
}
